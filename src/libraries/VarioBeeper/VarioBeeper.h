...
#define BEEP_VELOCITY_SISITIVITY		(0.1)
...
{
public:
	VarioBeeper(SoundPlayer & sp, double climbingThreshold = BEEP_DEFAULT_CLIMBING_THRESHOLD, double sinkingThreshold = BEEP_DEFAULT_SINKING_THRESHOLD);
